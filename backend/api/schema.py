...
class Preprocessed_Products(me.Document):
    ...
    # sentiment = me.StringField()
    similarity = me.StringField()
    f1_sentiment = me.FloatField()
    f2_sentiment = me.FloatField()
    f3_sentiment = me.FloatField()
    f4_sentiment = me.FloatField()
...
# class Ranked_Lipsticks(me.Document):
#     meta = {'collection': 'Ranked_Lipsticks'}
...
# class Preprocessed_Lipsticks(me.Document):
#     meta = {'collection': 'Preprocessed_Lipsticks'}
